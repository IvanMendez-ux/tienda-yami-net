...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("Host=aws-1-sa-east-1.pooler.supabase.com;Port=6543;Database=postgres;Username=postgres.pzazklrkawweslpcoify;Password='q@54._%r*6TF@WX';SSL Mode=Require;Trust Server Certificate=true");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.Id).HasName("categorías_pkey");
        ...
        modelBuilder.Entity<Image>(entity =>
        {
            ...
            entity.HasOne(d => d.IdProductNavigation).WithMany(p => p.Images)
                ...
                .HasConstraintName("images_id_product_fkey");
        });
        ...
        modelBuilder.Entity<Product>(entity =>
        {
            ...
            entity.ToTable("products", tb => tb.HasComment("mis productos"));
        ...
        {
            entity.HasKey(e => e.Id).HasName("detail_products_pkey");
            ...
            entity.HasOne(d => d.IdProductoNavigation).WithMany(p => p.ProductDetails)
                .HasForeignKey(d => d.IdProducto)
                .HasConstraintName("detail_products_id_producto_fkey");
        });
        ...
        {
            entity.HasKey(e => e.Id).HasName("ubicaciones_pkey");
